                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        ...
                        style: const TextStyle(
                            fontSize: 17,
                            color: Color.fromARGB(255, 238, 178, 200)),
                      ),
                      const SizedBox(
                        height: 42,
                      ),
...
Padding ratingandMore(LocationDetail location) {
  return Padding(
    ...
    child: Row(
      ...
      children: [
        ...
        Text(
          ...
          style: const TextStyle(
              fontSize: 20, fontWeight: FontWeight.bold, color: Color(0xFFB07C97)),
        ),
        const SizedBox(
          width: 30,
        ),
